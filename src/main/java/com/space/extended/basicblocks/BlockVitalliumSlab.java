...
public abstract class BlockVitalliumSlab extends BlockSlab {
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

	public BlockVitalliumSlab() {
		super(Material.IRON);
	...
	public static class Double extends BlockVitalliumSlab {
		@Override
	...
	public static class Half extends BlockVitalliumSlab {
		@Override
		public boolean isDouble() {
			return false;
		}
