...
public abstract class BlockMetalFrameSlab extends BlockSlab {
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

	public BlockMetalFrameSlab() {
		super(Material.IRON);
	...
	public static class Double extends BlockMetalFrameSlab {
		@Override
	...
	public static class Half extends BlockMetalFrameSlab {
		@Override
		public boolean isDouble() {
			return false;
		}
