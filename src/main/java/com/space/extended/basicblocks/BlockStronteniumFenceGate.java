...
public class BlockStronteniumFenceGate extends BlockHorizontal {
	...
	public BlockStronteniumFenceGate(Material material_) {
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		...
		return state.getValue(IN_WALL).booleanValue()
				? (state.getValue(FACING).getAxis() == EnumFacing.Axis.X ? AABB_COLLIDE_XAXIS_INWALL
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if (((enumfacing$axis == EnumFacing.Axis.Z) && (canFenceGateConnectTo(worldIn, pos, EnumFacing.WEST)
	...
	public AxisAlignedBB getCollisionBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
		return blockState.getValue(OPEN).booleanValue() ? NULL_AABB
				: (blockState.getValue(FACING).getAxis() == EnumFacing.Axis.Z ? AABB_CLOSED_SELECTED_ZAXIS
