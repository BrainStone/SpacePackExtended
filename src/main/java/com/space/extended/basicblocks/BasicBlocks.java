...
public class BasicBlocks {
	...
	private void init() {
		...
		constructor2 = new BlockConstructor2().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(constructor2, "constructor2");
		constructor3 = new BlockConstructor3().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(constructor3, "constructor3");
		constructor4 = new BlockConstructor4().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(constructor4, "constructor4");
		constructor5 = new BlockConstructor5().setCreativeTab(SpaceExtendedMain.spaceTab);
		...
		strontenium1 = new BlockStrontenium1().setCreativeTab(SpaceExtendedMain.spaceTab);
		...
		klingonium1 = new BlockKlingonium1().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium1, "klingonium1");
		klingonium2 = new BlockKlingonium2().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium2, "klingonium2");
		klingonium3 = new BlockKlingonium3().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium3, "klingonium3");
		klingonium_wall0 = new BlockKlingonium_Wall0().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall0, "klingonium_wall0");
		klingonium_wall1 = new BlockKlingonium_Wall1().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall1, "klingonium_wall1");
		klingonium_wall2 = new BlockKlingonium_Wall2().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall2, "klingonium_wall2");
		klingonium_wall3 = new BlockKlingonium_Wall3().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall3, "klingonium_wall3");
		klingonium_wall4 = new BlockKlingonium_Wall4().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall4, "klingonium_wall4");
		klingonium_wall5 = new BlockKlingonium_Wall5().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall5, "klingonium_wall5");
		klingonium_wall6 = new BlockKlingonium_Wall6().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall6, "klingonium_wall6");
		klingonium_wall7 = new BlockKlingonium_Wall7().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(klingonium_wall7, "klingonium_wall7");
		klingonium_wall8 = new BlockKlingonium_Wall8().setCreativeTab(SpaceExtendedMain.spaceTab);
		...
		strontenitb = new BlockStrontenitB().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(strontenitb, "strontenitb");
		strontenitc = new BlockStrontenitC().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(strontenitc, "strontenitc");
		strontenitd = new BlockStrontenitD().setCreativeTab(SpaceExtendedMain.spaceTab);
		...
		perola = new BlockPerolA().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(perola, "perola");
		perolb = new BlockPerolB().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(perolb, "perolb");
		perolc = new BlockPerolC().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(perolc, "perolc");
		perold = new BlockPerolD().setCreativeTab(SpaceExtendedMain.spaceTab);
		...
		strontopala = new BlockStrontopalA().setCreativeTab(SpaceExtendedMain.spaceTab);
		NameUtils.setNames(strontopala, "strontopala");
		strontopalb = new BlockStrontopalB().setCreativeTab(SpaceExtendedMain.spaceTab);
