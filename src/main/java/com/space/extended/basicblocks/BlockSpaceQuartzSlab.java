...
public abstract class BlockSpaceQuartzSlab extends BlockSlab {
	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);

	public BlockSpaceQuartzSlab() {
		super(Material.IRON);
	...
	public static class Double extends BlockSpaceQuartzSlab {
		@Override
	...
	public static class Half extends BlockSpaceQuartzSlab {
		@Override
		public boolean isDouble() {
			return false;
		}
