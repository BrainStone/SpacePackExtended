...
public class BasicWorldgenerater implements IWorldGenerator {
	...
	private void overworld(Random random, int x, int z, World world) {
		GenerationUtil.generateOre(BasicBlocks.vitalliumOre.getDefaultState(), random, x, z, world, 8, 17, 64, 3, 5);
		GenerationUtil.generateOre(BasicBlocks.klingoniumOre.getDefaultState(), random, x, z, world, 7, 30, 64, 3, 4);
